<template>
    ...
    <div class="card">
        ...
        <DataTable ref="dt" v-model:filters="filters" v-model:selection="selectedUsers" :value="admins" paginator :rows="10" dataKey="id" filterDisplay="menu"
            ...
            <template #empty> Không tìm thấy người quản trị. </template>
...
const form = useForm('post', 'admins', {
    id: '',
    name: '',
    email: '',
    password: '',
...
const deleteSelectedUsers = () => {
    router.post('admins/bulkDelete', {admins : selectedUsers.value }, {
        onSuccess: () => {
